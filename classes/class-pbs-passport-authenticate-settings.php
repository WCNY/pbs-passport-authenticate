...
class PBS_Passport_Authenticate_Settings { 
  ...
  public function setup_admin_scripts() {
    ...
    add_settings_field( 'join_url', 'Join/Donate URL', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'join_url', 'class' => 'regular-text', 'label' => 'Link to the specific donate form people should be directed to from the login screen.'  ) );
     ...
     add_settings_field( 'contact-us', 'Contact Us URL', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'contact-us', 'class' => 'regular-text', 'label' => 'Link to passport contact form.'  ) );
     add_settings_field( 'privacy-policy', 'Privacy Policy URL', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'privacy-policy', 'class' => 'regular-text', 'label' => 'Link to station or PBS Privacy Policy.'  ) );
     add_settings_field( 'terms-of-service', 'Terms of Service URL', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'terms-of-service', 'class' => 'regular-text', 'label' => 'Link to station or PBS Terms of Service.'  ) );
     add_settings_field('after_login_url', 'After Login URL', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'after_login_url', 'class' => 'regular-text', 'label' => 'Static link to refer users back to after login. Leave blank to return to user\'s previous page.'  ));
     add_settings_field('account_setup_url', 'Token Lookup URL', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'account_setup_url', 'class' => 'regular-text', 'label' => 'Static link for users to request Passport activation tokens. Leave blank to default to pbsoauth/alreadyamember for a member token lookup form.'  ));
     add_settings_field('account_setup_btn', 'Token Lookup Button', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'account_setup_btn', 'class' => 'regular-text', 'label' => 'Text for "Token Lookup" button. Defaults to "Lookup My Code".'  ));
     add_settings_field('token_request_url', 'Token Request URL', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'token_request_url', 'class' => 'regular-text', 'label' => 'Static link to another page, added to the site with a contact form where the member can request their Activation Code or Member Information from the Station. Button will not display if left blank.'  ));
     add_settings_field('token_request_btn', 'Token Request Button', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'token_request_btn', 'class' => 'regular-text', 'label' => 'Text for "Token Request" button. If left blank, it will default to "Request My Code".'  ));
