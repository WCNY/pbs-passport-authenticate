...
class PBS_Passport_Authenticate_Settings { 
  ...
  public function setup_admin_scripts() {
    ...
    add_settings_field( 'join_url', 'Join/Donate URL', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'join_url', 'class' => 'regular-text', 'label' => 'Link to the specific donate form people should be directed to from the login screen.'  ) );
     ...
     add_settings_field('account_setup_url', 'Account Setup URL', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'account_setup_url', 'class' => 'regular-text', 'label' => 'Static link for users to request Passport activation tokens and account setup. Leave blank to default to pbsoauth/alreadymember for a member token lookup form.'  ));
     add_settings_field('account_setup_btn', 'Account Setup Button', array( $this, 'settings_field'), 'pbs_passport_authenticate', 'general_settings', array('setting' => 'pbs_passport_authenticate', 'field' => 'account_setup_btn', 'class' => 'regular-text', 'label' => 'Text for "Account Setup" button. Defaults to "Request Account Setup".'  ));
